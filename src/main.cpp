  ...
  h.onMessage([&map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
		...
		vector<double> next_wp0 = getXY(car_s + 30, laneVal, map_waypoints_s,
		                                        map_waypoints_x, map_waypoints_y);

		vector<double> next_wp1 = getXY(car_s + 60, laneVal, map_waypoints_s,
		                                        map_waypoints_x, map_waypoints_y);

		vector<double> next_wp2 = getXY(car_s + 90, laneVal,  map_waypoints_s,
		                                        map_waypoints_x, map_waypoints_y);
		 ...
		 */
                ...
                cout << "50- previous_path_x.size() = " << 100-previous_path_x.size() << std::endl;
